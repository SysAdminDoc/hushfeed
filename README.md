...
| `Follow diagnostics` | Reports the first refused follow and its reason each session, including nearby follows and follower removals. Optional diagnostics retains at most 160 requests. Refusal notices still work after that limit. |
