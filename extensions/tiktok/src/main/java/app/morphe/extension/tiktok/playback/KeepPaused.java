 ...
 * observers, where the player stops. If the reader had paused that video, the play method turns
 * those plays down for it the way TikTok turns a play down while it is casting, and the reader's
 * own tap resumes the player as before, which does not go through that method.
 *
