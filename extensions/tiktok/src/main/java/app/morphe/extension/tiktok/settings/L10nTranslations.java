...
public final class L10nTranslations {
    ...
    private static void fillDe9(Map<String, String> table) {
        ...
        table.put("Hushfeed can't be paused while Wait a day to loosen the budget is on",
                "Hushfeed kann nicht pausiert werden, solange Lockerungen des Budgets einen Tag warten lassen an ist");
    ...
    private static void fillEs9(Map<String, String> table) {
        ...
        table.put("Hushfeed can't be paused while Wait a day to loosen the budget is on",
                "Hushfeed no se puede pausar mientras Esperar un día para aflojar el presupuesto esté activado");
        table.put("Hushfeed cannot read the creator pattern %1$s",
    ...
    private static void fillIn9(Map<String, String> table) {
        ...
        table.put("Hushfeed can't be paused while Wait a day to loosen the budget is on",
                "Hushfeed tidak bisa dijeda selama Tunggu sehari untuk melonggarkan anggaran aktif");
        table.put("Hushfeed cannot read the creator pattern %1$s",
    ...
    private static void fillPt_rBR9(Map<String, String> table) {
        ...
        table.put("Hushfeed can't be paused while Wait a day to loosen the budget is on",
                "O Hushfeed não pode ser pausado enquanto Esperar um dia para afrouxar o limite estiver ligado");
        table.put("Hushfeed cannot read the creator pattern %1$s",
    ...
    private static void fillTr9(Map<String, String> table) {
        ...
        table.put("Hushfeed can't be paused while Wait a day to loosen the budget is on",
                "Bütçeyi gevşetmek için bir gün bekle açıkken Hushfeed duraklatılamaz");
        table.put("Hushfeed cannot read the creator pattern %1$s",
