...
val hideVideoOverlaysPatch = bytecodePatch(
    ...
    description = "Hides the visual search prompt TikTok lays over videos and the Live " +
        "entrance in the top left corner, each with its own switch. Supports TikTok 46.2.3.",
    default = false,
) {
